...
public class HexGridChunk : MonoBehaviour
{
	...
	void Awake ()
    {
		...
		this.cells = new HexCell[HexMetrics.chunkSizeX * HexMetrics.chunkSizeZ];
	}
	...
	void InitCell (HexCell cell)
    {
		for (HexDirection d = HexDirection.NE; d <= HexDirection.NW; d++)
        {
			InitCellDirection(d, cell);
		}
	...
	void InitCellDirection (HexDirection direction, HexCell cell)
    {
