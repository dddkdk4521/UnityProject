...
public class HexGrid : MonoBehaviour
{
	...
	void Awake ()
    {
        ...
        this.cellShaderData = gameObject.AddComponent<HexCellShaderData>();
	...
	public HexCell GetCell (Ray ray)
    {
        ...
        {
			return GetCellToControllerPosition(hit.point);
		}
		return null;
	}

	public HexCell GetCellToControllerPosition (Vector3 position)
    {
	...
	public void FindPath (HexCell fromCell, HexCell toCell, int speed)
    {
		...
		this.currentPathExists = Search(fromCell, toCell, speed);
	...
	List<HexCell> GetVisibleCells (HexCell fromCell, int range)
    {
        ...
        {
			HexCell current = this.searchFrontier.Dequeue();
			current.SearchPhase += 1;
